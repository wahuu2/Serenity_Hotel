    ...
    <main className="min-h-screen bg-gray-50">
      <section className="bg-gray-900 px-6 py-16 text-center text-white">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-gray-300">
          Enter your email address to view your Serenity Hotel
          reservations.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        >
          ...
          <p className="mt-2 text-gray-600">
            Use the email address you provided when making your
            reservation.
          </p>
          ...
          <div className="mt-6 flex flex-col gap-4 md:flex-row">
            <input
              ...
              className="flex-1 rounded-md border px-4 py-3 outline-none focus:ring-2 focus:ring-gray-400"
              required
            />
        ...
        {searched && bookings.length === 0 && (
          <div className="mt-8 rounded-xl bg-white p-10 text-center shadow-sm">
            ...
            <p className="mt-3 text-gray-600">
              We couldn't find any reservations associated with
              this email address.
            </p>
          </div>
        )}
